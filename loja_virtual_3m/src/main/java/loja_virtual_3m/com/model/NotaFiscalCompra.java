...
public class NotaFiscalCompra implements Serializable {
	...
	public BigDecimal getValotDesconto() {
		return valotDesconto;
	}

	public void setValotDesconto(BigDecimal valotDesconto) {
		this.valotDesconto = valotDesconto;
	}

	public BigDecimal getValotIcms() {
		return valotIcms;
	}

	public void setValotIcms(BigDecimal valotIcms) {
		this.valotIcms = valotIcms;
	}
